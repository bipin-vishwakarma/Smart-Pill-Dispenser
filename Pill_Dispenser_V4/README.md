# 💊 Smart Pill Dispenser V4 - ESP32-S3 Powered

![Pill Dispenser Hero Image](assets/hero.png)

## 🚀 Overview

The **Pill Dispenser V4** is a high-performance, compact, and automated solution for medication management. Powered by an **ESP32-S3**, this version integrates smart scheduling, Li-Ion battery management, and an OLED interface for a seamless user experience.
